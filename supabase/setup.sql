...
--
-- ■ 中身（migrations/ の 002〜011 をこの順につないだもの）
--   002 … 食堂・時間割・課外活動の団体
--   003 … 学部6学科17・課外活動97団体・もとにした Word
--   004 … 時限の時刻・イベント・登録の優先順位・知らせ
--   005 … 予定をまとめて登録する（号館ごと・全号館用）
--   006 … 学科のクラス記号・教室番号に号館の番号を含める
--   007 … 教室の登録を Lv3 だけにする
--   008 … 管理者Lv0（大学の情報・食堂）・予定の削除
--   009 … 一つの教室の一つの時間には一つだけ
--   010 … 申請の情報（氏名・学年・クラス・組）・Lv3の締め・操作パスワード
--   011 … 席はあるのに情報が無い人を、その場で作り直す
--
-- ■ このあとに必ずやること
--   supabase/first_admin.sql を実行して、
--   操作パスワードを決め、自分を管理者にする。
